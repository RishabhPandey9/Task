        ...
        >
          {data.map((user) => {
              ...
              return (
                <div key={user.id}>
                  <Link to="/Jobs">
                  <div className="mb-2 text-lg font-semibold text-blue-700"> Posted jobs / {cookies.get("check")} / {user.position_name} </div>
                  </Link>
                ...
                <div>
                  ...
                  <div className="flex mt-5 text-sm font-semibold ml-2 md:ml-20">
                    <div className="grid gap-y-5">
                      ...
                      <div className="grid gap-y-2">
                        ...
                        <div>{user.stipend}</div>
                      </div>
                      <div className="grid gap-y-2">
                        <div className="text-gray-400 ">Role</div>
                        <div>{user.job_description}</div>
                      </div>
                      <div className="grid gap-y-2">
                        <div className="text-gray-400 ">Role Categoty</div>
                        <div>{user.role_category}</div>
                      </div>
                    </div>
                    <div className="grid gap-y-5 ml-10 md:ml-40">
                      ...
                      <div className="grid gap-y-2">
                        ...
                        <div className="w-2/3 md:w-full">{user.criteria}</div>
                      </div>
                      <div className="grid gap-y-2">
                  ...
                  <div className="md:ml-20 mt-5 font-semibold text-sm  ">
                    ...
                    {myArray.map((items)=>
                      ...
                      <div key={items} className="bg-gray-300 text-center p-2 px-6 rounded-3xl">{items} </div>
